      ...
      new ReactNativeHost(this) {
        ...
        protected List<ReactPackage> getPackages() {
          ...
          // packages.add(new MyReactNativePackage());
            ...
            // add all the native modules to the react native package to be returned to Javascript
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.portic_tech_modules.ReactNativeFlipper");
        aClass
